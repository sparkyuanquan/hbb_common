...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "ab123456".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.800688.xyz:50006"];
pub const RS_PUB_KEY: &str = "s8y20UARvofD5YR3kooTgUtZcmtEFopqr+9hfkjkeHw=";
