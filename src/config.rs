...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "479803".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["home.zyen.top"];
pub const RS_PUB_KEY: &str = "45f5swB8halT8aVgI6O1qu9BHbqB6dTBgttp1sddRnA=";
