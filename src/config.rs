...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "L.juji9ko".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["r.pvier.cn"];
pub const RS_PUB_KEY: &str = "LoLTX+fNlNrHoDJwhHpMyJvARg3WyKpWlo9QKsUCeCQ=";
